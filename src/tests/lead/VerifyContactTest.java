...
//	    Thread.sleep(400);
	...
	public void verifyContactDetails() {
		WebElement contact=driver.findElement(By.xpath("/html/body/div[4]/div[1]/section/div[1]/div[1]/one-appnav/div/one-app-nav-bar/nav/div/one-app-nav-bar-item-root[5]"));
		contact.click();
        driver.manage().timeouts().implicitlyWait(20, TimeUnit.SECONDS);
        WebElement allcontact;
        for(int i=1;;i++) {
        	try {
        		allcontact=driver.findElement(By.xpath("//*[@id=\"brandBand_1\"]/div/div/div/div/div[2]/div/div[1]/div[2]/div[2]/div[1]/div/div/table/tbody/tr["+i+"]/th/span/a"));
//        		System.out.println(allcontact.getText());
        		if(allcontact.getText().equals(firstName+" "+lastName)) {
        			Assert.assertEquals(allcontact.getText(),firstName+" "+lastName);
        		    break;
        		}	
        	}catch(Exception e) {
        		break;
